...
while($row = mysqli_fetch_array($result)) {
  ...
  $r = mysqli_query($con, "SELECT subject.subjcode, subject.subjname, login_faculty.tname, login_faculty.email from login_faculty, subject WHERE login_faculty.id = subject.tid AND login_faculty.id='$name'") or die('Error');
